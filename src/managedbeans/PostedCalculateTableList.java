...
@CCGenClass (expressionBase="#{d.PostedCalculateTableList}")

public class PostedCalculateTableList extends PageBean implements Serializable{
	private Rec_posted_calculate_table listModel = new Rec_posted_calculate_table();
	...
	public class MyRow extends FIXGRIDItem implements java.io.Serializable{
		...
		String varActual_afternoon_IN_copy1;
		public String getVarActual_afternoon_IN_copy1(){return varActual_afternoon_IN_copy1;}
		public void setVarActual_afternoon_IN_copy1(String value){this.varActual_afternoon_IN_copy1 = value;}
	...
	public void build(){
		try{
			...
			//TODO Get Table Data
			List<Rec_posted_calculate_table> results = Rec_posted_calculate_table.findAll();
			for(Rec_posted_calculate_table result : results){
				MyRow row = new MyRow();
				...
				row.setVarActual_afternoon_IN_copy1(tool.formatSQLTime(result.getDate(fieldNameArray.get(15))));
	...
	private ArrayList<String> currentRowArray(){
		...
		arrayList.add(currentRecord.getVarActual_afternoon_IN_copy1());
	...
	private ArrayList<String> pastRowArray(){
		...
		arrayList.add(xRecord.getVarActual_afternoon_IN_copy1());
	...
	private void popupCard(ArrayList<String> row, boolean isEnabled){
		//Write code to pop up card
        /*try{
            PostedCalculateTableList popupCardVar = new PostedCalculateTableList();
            ...
            ModalPopup popup = openModalPopup(popupCardVar, "PostedCalculateTableList Card", 0, 0,
            ...
            popup.maximize(true);
            popupCardVar.prepare(new PostedCalculateTableList.ICloseListener() {
                @Override
	...
	private MyRow emptyRow(){
		...
		row.setVarActual_afternoon_IN_copy1("");
		row.setVarLate("0");
		row.setVarAbsent("0");
	...
	public PostedCalculateTableList(){
	}
	public String getPageName() { return "/PostedCalculateTableList.jsp"; }
	public String getRootExpressionUsedInPage() { return "#{d.PostedCalculateTableList}"; }
